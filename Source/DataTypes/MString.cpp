...
Array<String> FString::split(const String& s, char delim)
{
	Array<String> elems;
...
String FString::getFilePath(const String& fileName)
{
...
bool FString::loadTextFileWithIncludes(String& output, const String& fileName,
	...
	if(file.is_open()) {
		while(file.good()) {
			...
			if(line.find(includeKeyword) == String::npos) {
				...
				String includeFileName = FString::split(line, ' ')[1];
				includeFileName =
