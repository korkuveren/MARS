...
bool Plane::intersectPlanes(Vector3D& intersectionPoint, const Plane& other1, const Plane& other2, float errorMargin) const
{
	...
	intersectionPoint = Vector3D(invDet*(w0*cross12+w1*cross20+w2*cross01));
	return true;
}
