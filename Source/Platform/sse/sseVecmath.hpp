...
#include "Math/Math.h"
#include "Platform/PlatformSIMDInclude.h"
...
//	}
	...
	FORCEINLINE SSEVector ToNeg() const
	{
		SSEVector vec;
	...
	{
		const auto* m = (const SSEVector*)matrix;
